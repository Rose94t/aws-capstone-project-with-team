...
DATABASES = {
    'default': {
        ...
        'HOST': 'aws-capstone-rds.c5mhb5lnpcsr.us-east-1.rds.amazonaws.com',  # database endpoint is written here
...
AWS_STORAGE_BUCKET_NAME = 'havvablog' # please enter your s3 bucket name
